				...
				<div className="bracket-container">
				  <div className="tournament-bracket tournament-bracket--rounded">
				      ...
				      <ul className="tournament-bracket__list">
				      	<KnockoutGame game="1" field="4" time="11:20am" />
				        <KnockoutGame game="2" field="5" time="11:20am" />
				      </ul>
				    </div>
				    <div className="tournament-bracket__round tournament-bracket__round--quarterfinals">
				      <h3 className="tournament-bracket__round-title">Championship</h3>
				      <ul className="tournament-bracket__list">
				      	<KnockoutGame game="3" field="4" time="12:40pm" />
				      </ul>
				    </div>
				  </div>
				</div>
				...
				<div className="bracket-container">
				  <div className="tournament-bracket tournament-bracket--rounded">
				    ...
				    <div className="tournament-bracket__round tournament-bracket__round--quarterfinals">
				      ...
				      <ul className="tournament-bracket__list">
				        <KnockoutGame game="5" field="5" time="2:40pm"/>
				        <KnockoutGame game="6" field="6" time="2:40pm"/>
				        <KnockoutGame game="7" field="7" time="2:40pm"/>
				        <KnockoutGame game="8" field="5" time="3:20pm"/>
				        <KnockoutGame game="9" field="6" time="3:20pm"/>
				        <KnockoutGame game="10" field="7" time="3:20pm"/>
				        <KnockoutGame game="11" field="5" time="4:00pm"/>
				        <KnockoutGame game="12" field="6" time="4:00pm"/>
				      </ul>
				    </div>
				    ...
				    <div className="tournament-bracket__round tournament-bracket__round--quarterfinals">
				      ...
				      <ul className="tournament-bracket__list">
				        <KnockoutGame game="13" field="1" time="5:20pm"/>
				        <KnockoutGame game="14" field="3" time="5:20pm"/>
				        <KnockoutGame game="15" field="1" time="6:00pm"/>
				        <KnockoutGame game="16" field="3" time="6:00pm"/>
				      </ul>
				    </div>
				    ...
				    <div className="tournament-bracket__round tournament-bracket__round--quarterfinals">
				      <h3 className="tournament-bracket__round-title">Semi-Finals</h3>
				      <ul className="tournament-bracket__list">
				        <KnockoutGame game="17" field="1" time="7:20pm"/>
				        <KnockoutGame game="18" field="3" time="7:20pm"/>
				      </ul>
				    </div>
				    ...
				    <div className="tournament-bracket__round tournament-bracket__round--gold">
				      <h3 className="tournament-bracket__round-title">Championship</h3>
				      <ul className="tournament-bracket__list">
				        <KnockoutGame game="19" field="1" time="8:40pm"/>
				      </ul>
				    </div>
				  </div>
				</div>
